...
forms.signup = [
  ...
  {name: 'first_name', type: 'text', std: 'First Name', ctx: null, desc: 'Optional, this helps if you\'re forgetful like I am.'},
  {name: 'last_name', type: 'text', std: 'Last Name', ctx: null, desc: null},
